    ...
    <aside class="sidebar-backend d-none d-md-flex flex-column flex-shrink-0 h-100" style="width: 256px;">
        ...
        <nav class="flex-grow-1 overflow-auto sidebar-scroll py-4 px-3">
            <ul class="nav flex-column gap-1">
                <li class="nav-item">
                    <a href="../dashboard/dashboard.html" class="nav-link sidebar-item d-flex align-items-center gap-2 py-2 px-3">
                ...
                <li class="nav-item">
                    <a href="../equipamentos/lista_equi.html"
                ...
                <li class="nav-item">
                    <a href="../localizacoes/lista_loc.html"
                        class="nav-link sidebar-item d-flex align-items-center gap-2 py-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <li class="nav-item">
                    <a href="../fornecedores/lista_fornecedores.html"
                        class="nav-link sidebar-item d-flex align-items-center gap-2 py-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="nav-item">
                    <a href="../documentacao/lista_docs.html"
                        class="nav-link sidebar-item d-flex align-items-center gap-2 py-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="nav-item">
                    <a href="../garantias/lista_garantias.html"
                        class="nav-link sidebar-item d-flex align-items-center gap-2 py-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <li class="nav-item">
                    <a href="../alertas/alertas.html"
                        class="nav-link sidebar-item active d-flex align-items-center gap-2 py-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <main class="flex-grow-1 overflow-auto p-4 p-md-5">
        ...
        <div class="dash-card p-4 mb-4">
            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="text-warning fs-4 pt-1">
                ...
                <div class="w-100">
                    ...
                    <h5 class="fw-bold text-dark mb-2">
                        Garantias a Expirar (próximos 30 dias)
                    </h5>

                    <p class="text-muted mb-4">
                        Contratos e garantias que expiram brevemente
                    </p>

                    <p class="text-muted mb-0">
                        Sem garantias a expirar
                    </p>
        ...
        <div class="dash-card p-4 mb-4">
            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="text-danger fs-4 pt-1">
                ...
                <div class="w-100">
                    ...
                    <p class="text-muted mb-4">
                        Contratos e garantias sem cobertura ativa
                    </p>

                    <p class="text-muted mb-0">
                        Sem garantias expiradas
                    </p>
        ...
        <div class="dash-card p-4 mb-4">
            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="w-100">
                    ...
                    <p class="text-muted mb-4">
                        Equipamentos que não têm qualquer documento registado
                    </p>

                    <p class="text-muted mb-0">
                        Todos os equipamentos têm documentação
                    </p>
        ...
        <div class="dash-card p-4 mb-4">
            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="w-100">
                    ...
                    <p class="text-muted mb-4">
                        Documentos cuja validade está ultrapassada
                    </p>

                    <p class="text-muted mb-0">
                        Sem documentos expirados
                    </p>
        ...
        <div class="dash-card p-5 text-center">
            ...
            <div class="mx-auto mb-4 rounded-circle d-flex align-items-center justify-content-center" style="width: 74px;
                       height: 74px;
            ...
            <h2 class="h3 fw-medium text-dark mb-3">
                Sem alertas ativos
            </h2>

            <p class="text-muted mb-0 mx-auto" style="max-width: 500px; line-height: 1.7;">

                Todas as garantias estão válidas,
                os documentos estão atualizados
                e todos os equipamentos têm documentação.
