<?php include '../../includes/header.php'; ?>
    ...
    <main class="flex-grow-1 overflow-auto p-4 p-md-5">
        ...
        <form action="lista_equi.html" method="GET" style="max-width: 1024px;" novalidate>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="equipamentoCodigoPrincipal" name="internalCode" class="form-control shadow-sm bg-light fw-bold text-muted" value="EQ-0002" readonly>
                                </div>
                                <div class="col-md-9">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="model" class="form-control shadow-sm"
                                        placeholder="Ex: IntelliVue MX700" required>
                                    <div class="invalid-feedback" style="font-size: 0.70rem;">Campo obrigatório.</div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="serialNumber" class="form-control shadow-sm"
                                        placeholder="SN-XXXX-0000" required>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul
                                            ...
                                            <div id="listaCategoria">
                                                ...
                                                <li><a class="dropdown-item py-2" href="#"
                                                        onclick="selecionarDropdown('categoria', 'Suporte de vida')">Suporte
                                                        de vida</a></li>
                                                <li><a class="dropdown-item py-2" href="#"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul
                                            ...
                                            <li><a class="dropdown-item py-2" href="#"
                                                    onclick="selecionarDropdown('criticidade', 'Suporte de vida')">Suporte
                                                    de vida</a></li>
                                        </ul>
                                        <div class="invalid-feedback" style="font-size: 0.70rem;">Campo obrigatório.
                                        </div>
                            ...
                            <div id="alertaPasso1" class="alert alert-danger p-2 text-center mt-4 mb-0 shadow-sm d-none"
                                role="alert">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul
                                                    class="dropdown-menu w-100 shadow-sm border-0 mt-1 dropdown-menu-scrollable">
                                                    <li><a class="dropdown-item py-2" href="#"
                                                            onclick="selecionarDropdown('status', 'Em Quarentena (Novo)')">Em
                                                            Quarentena (Novo)</a></li>
                                                    <li><a class="dropdown-item py-2" href="#"
                                                            onclick="selecionarDropdown('status', 'Ativo / Operacional')">Ativo
                                                            / Operacional</a></li>
                                                    <li><a class="dropdown-item py-2" href="#"
                                                            onclick="selecionarDropdown('status', 'Em Calibração')">Em
                                                            Calibração</a></li>
                                                </ul>
                                                <div class="invalid-feedback" style="font-size: 0.70rem;">Campo
                                                    obrigatório.</div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('[data-bs-wizard-step]').forEach(button => {
                button.addEventListener('click', function (e) {
                    ...
                    // E) Lógicas dos Passos 1 e 2 (Série, Ano e Custo)
                    const serialInput = painelAtual.querySelector('input[name="serialNumber"]');
                    if (serialInput && serialInput.value.trim() !== '') {
                        if (serialInput.value.trim().toUpperCase() === "SN-12345") {
                            serialInput.classList.add('is-invalid', 'border-danger');
                            if (feedbackSerial) feedbackSerial.innerText = "Este número de série já existe.";
                            tudoValido = false;
                        }
                    }
                    ...
                    if (custoInput && custoInput.value.trim() !== '') {
            ...
            if (formEquipamento) {
                formEquipamento.addEventListener('submit', function (e) {
                    // Impede o formulário de fazer o refresh automático da página
                    e.preventDefault();

                    const btnSubmit = document.getElementById('btnRegistarEquipamento');

                    // Efeito visual: Muda o botão para "A registar..." e põe o ícone a rodar
                    const textoOriginal = btnSubmit.innerHTML;
                    btnSubmit.innerHTML = '<i class="fa-solid fa-spinner fa-spin me-1"></i> A registar...';
                    btnSubmit.disabled = true;

                    // SIMULAÇÃO: Espera 1 segundo (fingindo que está a falar com a Base de Dados)
                    setTimeout(() => {
                        // Mostra o alerta de sucesso
                        alert("Equipamento registado com sucesso no MedStock!");

                        // Redireciona o utilizador de volta para a tabela de equipamentos
                        window.location.href = "lista_equi.html";
                    }, 1000);
                });
            }
        });
    ...
    <script>
        ...
        function selecionarDropdown(campoId, valorSelecionado) {
            ...
            // 2. Coloca o valor no input invisível
        ...
        async function atualizarFornecedores(event) {
            ...
            try {
                ...
                const listasParaAtualizar = [
                    { idLista: 'listaManufacturer', campoInput: 'manufacturer' },
                    { idLista: 'listaFornecedor', campoInput: 'fornecedor' },
                    { idLista: 'listaAssistencia', campoInput: 'assistencia' },
                    { idLista: 'listaConsumiveis', campoInput: 'consumiveis' }
                ];
